...
<body>
<form action="${pageContext.request.contextPath }/insertStockOut" method="post" class="definewidth m20">
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td><input type="text" name="sUnitName"/></td>
    </tr>
    <tr>
        <td class="tableleft">负责人</td>
         <td><input type="text" name="sResponsiblePerson"/></td>
    </tr>
    <tr>
        <td class="tableleft">联系电话</td>
         <td><input type="text" name="sTelphone"/></td>
    </tr>
     <tr>
...
<script>
    $(function () {       
		$('#backid').click(function(){
				window.location.href="${pageContext.request.contextPath }/listStockOut";
		 });
    });
    $(function () {
