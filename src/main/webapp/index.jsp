...
<script>
    BUI.use('common/main',function(){
       var config = [
			        ...
			        ,{id:'11',homePage : '11',menu:[{text:'实时数据',items:[{id:'11',text:'实时数据',href:'listDevRealtimeData'},{id:'31',text:'历史数据',href:'selectStockInMapByPage'}]}]}
...
/* 			        ,{id:'13',homePage : '13',menu:[{text:'统计分析',items:[{id:'13',text:'图形曲线',href:'chart.jsp'},{id:'33',text:'统计报表',href:'Warning/index1.html'}]}]} */
			        ...
			        ,{id:'1',homePage : '4',menu:[{text:'系统管理',items:[{id:'4',text:'用户管理',href:'selectUserList'},{id:'4',text:'日志管理',href:'logInfo'},{id:'4',text:'帮助',href:'help.jsp'}]}]}
