...
<script>
    BUI.use('common/main',function(){
       var config = [
			         {id:'7',homePage : '9',menu:[{text:'地图站点',items:[{id:'9',text:'物资定位',href:'listDevAttr'}/* ,{id:'9',text:'查询站点测试',href:'listDevAttrTest'},{id:'9',text:'查询站点测试2',href:'listDevAttrTest2'} */]}]}
			        ,{id:'11',homePage : '11',menu:[{text:'实时数据',items:[{id:'11',text:'实时数据',href:'listDevRealtimeData'},{id:'31',text:'历史数据',href:'listDevHisData'}]}]}
			        ,{id:'12',homePage : '12',menu:[{text:'告警管理',items:[{id:'12',text:'当前告警',href:'listDevAlarmnow'},{id:'32',text:'历史告警',href:'listDevAlarm'},{id:'42',text:'告警配置',href:'Warning/index.html'}]}]}
/* 			        ,{id:'13',homePage : '13',menu:[{text:'统计分析',items:[{id:'13',text:'图形曲线',href:'chart.jsp'},{id:'33',text:'统计报表',href:'Warning/index1.html'}]}]} */
			        ,{id:'15',homePage : '15',menu:[{text:'仓储管理',items:[{id:'15',text:'分类管理',href:'selectTypeList'},{id:'15',text:'入库管理',href:'listStockIn'},{id:'35',text:'出库管理',href:'listStockOut'}]}]}
