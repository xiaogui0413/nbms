...
<script>
    BUI.use('common/main',function(){
       var config = [
			         {id:'7',homePage : '9',menu:[{text:'地图站点',items:[{id:'9',text:'查询站点',href:'listDevAttr'}/* ,{id:'9',text:'查询站点测试',href:'listDevAttrTest'},{id:'9',text:'查询站点测试2',href:'listDevAttrTest2'} */]}]}
			        ,{id:'11',homePage : '11',menu:[{text:'实时数据',items:[{id:'11',text:'实时数据',href:'listDevRealtimeData'},{id:'31',text:'历史数据',href:'listDevHisData'}]}]}
			        ,{id:'12',homePage : '12',menu:[{text:'告警管理',items:[{id:'12',text:'当前告警',href:'Warning/index.html'},{id:'32',text:'历史告警',href:'Warning/index.html'},{id:'42',text:'告警配置',href:'Warning/index.html'}]}]}
