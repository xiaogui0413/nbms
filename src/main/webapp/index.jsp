...
<script>
    BUI.use('common/main',function(){
       var config = [{id:'1',homePage : '4',menu:[{text:'系统管理',items:[{id:'3',text:'角色管理',href:'Role/index.html'},{id:'4',text:'用户管理',href:'User/index.html'},{id:'6',text:'菜单管理',href:'Menu/index.html'}]}]}
			        ...
			        ,{id:'13',homePage : '13',menu:[{text:'统计分析',items:[{id:'13',text:'图形曲线',href:''},{id:'33',text:'统计报表',href:''}]}]}
			        ,{id:'15',homePage : '15',menu:[{text:'仓储管理',items:[{id:'15',text:'入库管理',href:'Stock/index.html'},{id:'35',text:'出库管理',href:'Stock/index2.html'}]}]}
