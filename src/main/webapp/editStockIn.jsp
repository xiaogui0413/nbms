...
<input type="hidden" name="id" value="{$user.id}" />
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td><input type="text" name="sStockIntType" value="${stock.sStockIntType }"/></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="tableleft">供应商名称</td>
             <td><input type="text" name="sSupplierName" value="${stock.sSupplierName }"/></td>
        </tr>      
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="StorageTime" value="${stock.storageTime }" class="form_datetime"/></td>
        </tr>
        <tr>
